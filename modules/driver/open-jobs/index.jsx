...
export default function DriverOpenJobsPage() {
  ...
  // Use isFetching to track active searches
  const {
    data: jobs,
    isLoading,
    isFetching,
          ...
          {jobs?.count > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center p-16 text-center bg-white rounded-lg border border-gray-200">
              ...
              <p className="text-gray-600 mt-2 max-w-md">
                There are no jobs available at the moment. Check back later or try different search criteria.
              </p>
            </div>
          )}
        </div>
