...
export default function CleanerMessagePage() {
  ...
  return (
    <div className="min-h-[calc(100vh-60px)] bg-black/10 lg:min-h-[calc(100vh-80px)]">
      {/* Header */}
      <div className="bg-primary text-lg font-semibold text-black py-4 lg:py-6 lg:text-2xl lg:mt-10">
      ...
      <Container>
        <div className="mx-auto mt-6 flex h-[80vh] max-w-7xl flex-col overflow-hidden rounded-lg bg-white shadow-md lg:mt-10 lg:flex-row">
          ...
          {/* Chat Window */}
          <div className="flex w-full flex-col p-4 lg:w-2/3 bg-white">
            {selectedMessage ? (
              <>
                {/* Chat Header */}
                <div className="flex items-center gap-4 border-b pb-2 mb-2 lg:pb-4">
                  <img
        ...
        <Link href="/profile" className="mt-10 flex justify-center">
          <Button size="lg" className="w-full max-w-xs mt-10" color="primary">
