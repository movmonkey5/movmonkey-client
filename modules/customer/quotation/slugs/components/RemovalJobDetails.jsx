        ...
        {!isLoading && jobDetails && (
          <div className="space-y-4">
            ...
            <div className="text-center mb-6">
              <div className="flex items-center justify-center mb-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-gray-600 text-sm mt-1">Complete overview of your removal service</p>
                </div>
              </div>
              <div
            ...
            <div className="flex justify-center mb-4">
              <div
                className="inline-flex items-center gap-2 text-white px-6 py-3 rounded-xl shadow-lg"
                style={{
                  background: "linear-gradient(135deg, #49B74B 0%, #3a9639 100%)",
                }}
              >
                <Tag className="w-4 h-4" />
                <span className="font-semibold">Removal Category: {jobDetails.category?.title}</span>
              </div>
            </div>
              ...
              <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <h4 className="text-xl font-bold text-white">Removal Service Overview</h4>
                  </div>
                </div>
                <div className="p-6">
