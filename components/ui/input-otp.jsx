  ...
  return (
    <div
      ...
      className={cn(
        ...
        isActive &&
          "dark:ring-offset-sering-secondary z-10 ring-2 ring-secondary ring-offset-white dark:ring-slate-300",
        className,
      )}
      {...props}
    >
      ...
      {hasFakeCaret && (
        <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
          <div className="animate-caret-blink bg-sering-secondary h-4 w-px duration-1000 dark:bg-slate-50" />
        </div>
      )}
    </div>
  );
